            ...
            <div className="All-Project">
              <div className="Project-lists">
                ...
                <div className="project-name">
                  ...
                  <a href="https://github.com/ANUJ-KUMAE/MedFest.git"><FaArrowRightToBracket className="Fa-Arrow"/></a>
                </div>
              </div>
              <div className="Project-lists">
                <div className="project-image">
                ...
                <div className="project-name">
                  ...
                  <a href="https://github.com/ANUJ-KUMAE/EduQuest.git"><FaArrowRightToBracket className="Fa-Arrow"/></a>
                </div>
              </div>
              <div className="Project-lists">
                <div className="project-image">
                ...
                <div className="project-name">
                  ...
                  <a href=""><FaArrowRightToBracket className="Fa-Arrow"/></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="All-Project">
              <div className="Project-lists">
                ...
                <div className="project-name">
                  ...
                  <a href="https://github.com/ANUJ-KUMAE/E-Commerce-Dashboard.git"><FaArrowRightToBracket className="Fa-Arrow"/></a>
                </div>
              </div>
              <div className="Project-lists">
                <div className="project-image">
            ...
            <div className="All-Project">
              ...
              <div className="Project-lists">
                ...
                <div className="title project-name">
                  ...
                  <a href="https://github.com/ANUJ-KUMAE/Schizophrenia.git"><FaArrowRightToBracket className="Fa-Arrow"/></a>
                </div>
              </div>
            </div>
          </div>
